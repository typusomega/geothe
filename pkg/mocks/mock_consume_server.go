...
// Source: github.com/typusomega/goethe/pkg/spec (interfaces: Goethe_ConsumeServer)
...
type MockGoethe_ConsumeServer struct {
	...
	recorder *MockGoethe_ConsumeServerMockRecorder
}
...
func NewMockGoethe_ConsumeServer(ctrl *gomock.Controller) *MockGoethe_ConsumeServer {
	mock := &MockGoethe_ConsumeServer{ctrl: ctrl}
	mock.recorder = &MockGoethe_ConsumeServerMockRecorder{mock}
	return mock
}
...
func (mr *MockGoethe_ConsumeServerMockRecorder) Context() *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Context", reflect.TypeOf((*MockGoethe_ConsumeServer)(nil).Context))
}
...
func (mr *MockGoethe_ConsumeServerMockRecorder) Recv() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Recv", reflect.TypeOf((*MockGoethe_ConsumeServer)(nil).Recv))
}
...
func (mr *MockGoethe_ConsumeServerMockRecorder) RecvMsg(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RecvMsg", reflect.TypeOf((*MockGoethe_ConsumeServer)(nil).RecvMsg), arg0)
}
...
func (mr *MockGoethe_ConsumeServerMockRecorder) Send(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Send", reflect.TypeOf((*MockGoethe_ConsumeServer)(nil).Send), arg0)
}
...
func (mr *MockGoethe_ConsumeServerMockRecorder) SendHeader(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendHeader", reflect.TypeOf((*MockGoethe_ConsumeServer)(nil).SendHeader), arg0)
}
...
func (mr *MockGoethe_ConsumeServerMockRecorder) SendMsg(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMsg", reflect.TypeOf((*MockGoethe_ConsumeServer)(nil).SendMsg), arg0)
}
...
func (mr *MockGoethe_ConsumeServerMockRecorder) SetHeader(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetHeader", reflect.TypeOf((*MockGoethe_ConsumeServer)(nil).SetHeader), arg0)
}
...
func (mr *MockGoethe_ConsumeServerMockRecorder) SetTrailer(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetTrailer", reflect.TypeOf((*MockGoethe_ConsumeServer)(nil).SetTrailer), arg0)
}
